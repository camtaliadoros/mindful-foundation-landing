  ...
  return (
    <div className='lg:grid lg:grid-cols-2 lg:grid-rows-6 flex flex-col h-screen'>
      ...
      <div className='bg-mf-blue w-full flex self-center h-full items-center justify-center lg:justify-end row-span-4'>
        <div className=' lg:justify-self-end lg:mr-4 flex flex-col h-8 lg:h-12 overflow-hidden [&_h2]:text-mf-green [&_h2]:text-3xl [&_h2]:lg:text-5xl [&_h2]:h-8 [&_h2]:lg:h-12  [&_h2]:mb-12 [&_h2]:inline-block [&_h2]:text-center [&_h2]:lg:text-right [&_h2]:leading-none'>
      ...
      <div className='[&_p]:text-mf-blue  [&_p]:text-sm [&_p]:md:text-base m-4 flex flex-col justify-center row-span-4 gap-4'>
        <p>
      ...
      <div className='bg-mf-blue lg:flex items-end hidden'>
        <p className='text-chalk font-bold text-xs md:text-base m-4'>
          Site being updated.
        </p>
      </div>
      <div className='p-4 [&_h3]:text-mf-blue [&_h3]:text-sm [&_h3]:lg:text-base [&_h3]:font-bold flex flex-col justify-end'>
        <h3>
